<template>
  <f7-page
    ...
    :ptr-preloader="showPtrPreloader"
  >
    <f7-block-title medium>{{ title }} ({{ totalCount }})</f7-block-title>
    <f7-block inner>
      <p>
...
export default {
  ...
  data() {
    return {
      ...
      smallTitle: `Detayli filtereleme icin menu'den kategori seciniz.`,
      query: null,
      totalCount: 0,
      assets: {},
      innerHeight: 0,
      ...
      self
        ...
        .then(r => {
          ...
          setTimeout(function() {
            ...
            self.bottomMessage = "Goruntulenek yeni yayin kalmadi.";
